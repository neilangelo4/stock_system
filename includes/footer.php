...
<!-- container -->
	...
	<!-- <script type="text/javascript" src="assets/plugins/js/plugins/canvas-to-blob.min.js"></script>
	<script type="text/javascript" src="assets/plugins/js/fileinput.min.js"></script>
	<script type="text/javascript" src="assets/plugins/js/fileinput.min.js"></script> -->
